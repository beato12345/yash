...
lottie_coding = load_lottieurl("https://lottie.host/03fe581a-6e46-4dea-8d40-6568b5fcd9fb/x0eRhynVpz.json")
...
with st.container():
    ...
    with left_column:
        ...
        st.write("[You be like this if you follow my tips carefully.](https://www.google.com/search?sca_esv=599792272&rlz=1C1CHZN_enPH1085PH1085&q=best+muscles&tbm=isch&source=lnms&sa=X&ved=2ahUKEwiOmZmGyumDAxXqS2wGHXVmArMQ0pQJegQIDhAB&biw=954&bih=935&dpr=1#imgrc=GEdfoxFJSDQfmM)")
        with right_column:
...
with st.container():
    ...
    with text_column:
        ...
        st.markdown("[Watch for proof...](https://www.youtube.com/watch?v=SoAIuq8fyEg&pp=ygUTY2hpY2tlbiBsaWZlIHJvYmxveA%3D%3D)")
...
with st.container():
    ...
    with image_column:
        ...
        st.markdown("[if you do this tip everyday,this will be the result](https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.pinterest.com%2Fpin%2Fbodybuilder--424956914816613292%2F&psig=AOvVaw0reEbeD5U2f154z9I9mThn&ust=1705845955497000&source=images&cd=vfe&opi=89978449&ved=0CBEQjRxqFwoTCNCf08SR7IMDFQAAAAAdAAAAABAD)")
